...
const CATEGORY_DATA: Record<DeviceCategory, BrandSeed[]> = {
  MOBILE: [
    ...
    { brand: "Samsung", models: ["Galaxy S21", "Galaxy S22", "Galaxy S22 Ultra", "Galaxy S23", "Galaxy S23 Ultra", "Galaxy S24", "Galaxy S24 Ultra", "Galaxy Note 20 Ultra", "Galaxy Z Fold 5", "Galaxy Z Flip 5", "Galaxy A54", "Galaxy A34", "Galaxy M14", "Galaxy M34", "Galaxy F14"] },
    { brand: "OnePlus", models: ["OnePlus 9", "OnePlus 9 Pro", "OnePlus 10 Pro", "OnePlus 11", "OnePlus 12", "OnePlus Nord 2", "OnePlus Nord 3", "OnePlus Nord CE 3", "OnePlus 11R", "OnePlus 12R"] },
    { brand: "Xiaomi", models: ["Redmi Note 10", "Redmi Note 11", "Redmi Note 12", "Redmi Note 13", "Redmi 12", "Redmi K50i", "Mi 11X", "Xiaomi 13 Pro", "Xiaomi 14"] },
    ...
    { brand: "POCO", models: ["Poco X5", "Poco X5 Pro", "Poco F5", "Poco M6 Pro", "Poco C55"] },
...
async function seedForBusiness(businessId: string) {
  let brandsCreated = 0, brandsBackfilled = 0, modelsCreated = 0;
  ...
  console.log(`  businessId=${businessId}: ${brandsCreated} brands created, ${brandsBackfilled} backfilled, ${modelsCreated} models created.`);
}
