    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <div className="max-w-3xl mx-auto px-6 py-10 print:py-0 print:px-0">
        <div className="flex items-center gap-4 mb-6 print:hidden">
          ...
          <h1 className="text-2xl font-semibold flex-1">Intake Receipt</h1>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 print:border-0 print:rounded-none">
          <div className="flex items-start justify-between border-b border-gray-200 pb-4 mb-4">
            <div className="flex items-center gap-3">
              {jobSheet.brandId?.logoUrl && (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={jobSheet.brandId.logoUrl} alt={jobSheet.brandId?.name || 'Brand'} className="h-10 w-auto object-contain" />
              )}
              <div>
                <h2 className="text-lg font-semibold">{jobSheet.brandId?.name ? `${jobSheet.brandId.name} Service Handover Report` : 'Service Handover Report'}</h2>
