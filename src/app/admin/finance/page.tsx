      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Revenue, collections, and payment tracking</p>
          </div>
          <Link
            href="/admin/sales"
        ...
        <div className="rounded-2xl border border-gray-200 bg-white overflow-hidden">
          ...
          {payments.length === 0 ? (
            <p className="px-6 py-10 text-center text-gray-400 text-sm">No payment records found</p>
          ) : (
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left px-6 py-3 text-gray-400 font-medium">Reference</th>
