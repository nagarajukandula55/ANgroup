  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-white">Product Categories</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          ...
          <div className="text-center">
            <p className="text-white font-medium">No categories found</p>
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-lg border border-white/[0.06] bg-white/[0.03] flex items-center justify-center flex-shrink-0 overflow-hidden">
                        {cat.imageUrl ? (
              ...
              <div>
                ...
                {formData.imageUrl && (
                  <div className="mt-2 flex items-center gap-3">
                    ...
                    />
                    <p className="text-xs text-zinc-500">Image preview</p>
                  </div>
                )}
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-lg bg-zinc-950 border border-white/[0.08] rounded-2xl overflow-hidden">
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div>
                <label className="text-xs text-zinc-500 block mb-1">
                  Type <span className="font-mono text-zinc-300">{modal.category.name}</span> to confirm
                </label>
                <input
