    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-2xl p-8 md:p-10">
          {/* Logo / Brand */}
          <div className="mb-8">
            <p className="text-[10px] uppercase tracking-[0.5em] text-zinc-500">AN Group</p>
            <h1 className="mt-3 text-3xl font-semibold text-white tracking-tight">Sign in</h1>
            <p className="mt-2 text-sm text-zinc-400">Enterprise Platform — Authorised Access Only</p>
          </div>
